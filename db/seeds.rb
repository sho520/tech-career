...
Location.create(prefecture: "青森県")
Location.create(prefecture: "岩手県")
Location.create(prefecture: "宮城県")
Location.create(prefecture: "秋田県")
Location.create(prefecture: "山形県")
Location.create(prefecture: "福島県")
...
Location.create(prefecture: "新潟県")
Location.create(prefecture: "富山県")
Location.create(prefecture: "石川県")
Location.create(prefecture: "福井県")
Location.create(prefecture: "山梨県")
Location.create(prefecture: "長野県")
Location.create(prefecture: "岐阜県")
Location.create(prefecture: "静岡県")
Location.create(prefecture: "愛知県")
Location.create(prefecture: "三重県")
Location.create(prefecture: "滋賀県")
Location.create(prefecture: "京都府")
Location.create(prefecture: "大阪府")
Location.create(prefecture: "兵庫県")
Location.create(prefecture: "奈良県")
Location.create(prefecture: "和歌山県")
Location.create(prefecture: "鳥取県")
Location.create(prefecture: "島根県")
Location.create(prefecture: "岡山県")
Location.create(prefecture: "広島県")
Location.create(prefecture: "山口県")
Location.create(prefecture: "徳島県")
Location.create(prefecture: "香川県")
Location.create(prefecture: "愛媛県")
Location.create(prefecture: "高知県")
Location.create(prefecture: "福岡県")
Location.create(prefecture: "佐賀県")
Location.create(prefecture: "長崎県")
Location.create(prefecture: "熊本県")
Location.create(prefecture: "大分県")
Location.create(prefecture: "宮崎県")
Location.create(prefecture: "鹿児島県")
...
Job.create(
  ...
  position: "営業",
  employee_type_id:4,
  job_description: "新規営業と既存の営業がメイン。また新人向け教育制度の準備をする",
  required_work_experience: "社会人経験5年以上、プログラミングの知識不問、金融業に詳しいと歓迎",
  working_hours: "10:00 - 19:00",
  break_time: "60",
  about_overtime: "有",
  recruitment_period: "今年中",
  number_of_recruitment_people:2,
  employment_period: "期間の定めのない雇用契約",
  add_info_working_time: "残業時間（月平均100時間以下）",
  salary_type: "年俸制",
  basic_salary:20,
  promotion: "有",
  bonus: "2",
  min_annual_income:350,
  max_annual_income:450,
  add_info_income: "特になし",
  example_annual_income: "35歳 500万",
  trial_period: "有 6ヶ月",
  add_info_trial_period: "6か月間は有期の雇用とする。",
  discretionary_labor_system: "有",
  fixed_overtime_pay: "有",
...
Student.create(
  ...
  period:52,
  team:"e",
  image: open("#{Rails.root}/db/dummy_images/person1.png"),
  advisor_id:2,
)
Student.create(
  email: "tsuru@tsuru",
  ...
  period:52,
  team:"e",
  image: open("#{Rails.root}/db/dummy_images/person2.png"),
  advisor_id:2,
)
Student.create(
  ...
  period:52,
  team:"e",
  image: open("#{Rails.root}/db/dummy_images/person3.png"),
  advisor_id:3,
)
Student.create(
  email: "usui@usui",
  ...
  period:53,
  team:"a",
  image: open("#{Rails.root}/db/dummy_images/person4.png"),
  advisor_id:3,
)
Student.create(
  email: "goto@goto",
  ...
  period:53,
  team:"e",
  image: open("#{Rails.root}/db/dummy_images/person5.png"),
  advisor_id:2,
)
Student.create(
  email: "kato@kato",
  ...
  period:53,
  team:"a",
  image: open("#{Rails.root}/db/dummy_images/person6.png"),
  advisor_id:4,
)
Student.create(
  ...
  period:53,
  team:"d",
  image:  open("#{Rails.root}/db/dummy_images/person7.png"),
  advisor_id:1,
)
